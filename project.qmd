...
Overall, our findings address the research question by showing that year, infant and adult mortality, BMI, thinness, economic status, and certain regions have significant relationships with life expectancy. Because this is an observational dataset, the associations we identify should not be interpreted as causal relationships. While methodology was relatively sound for the primary research question and the dataset was reliable and fairly valid, adopting more advanced modeling styles and using more comprehensive datasets in the future would strengthen the analysis and evidence for more expansive application of the model and its result, including in areas like policy recommendations. 
